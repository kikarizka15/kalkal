...
total_frames = 15
max_translation = -2.0 # Bergerak turun sejauh 2 satuan
...
def update(frame):
    ...
    # 3. Gerak Bayangan: Naik Vertikal
...
# --- BAGIAN TAMBAHAN UNTUK MENYIMPAN GIF ---
print("Sedang memproses file animasi.gif...")
anim.save('animasi.gif', writer='pillow', fps=5)
print("Selesai! File animasi.gif sudah siap di folder kamu.")
# -------------------------------------------
